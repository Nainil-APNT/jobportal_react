...
const APPLICATIONDETAILS_API_BASE_URL = "http://localhost:8888/applicationdetails";
const APPLICATIONDETAILS_API_BASE_URL_CREATE = "http://localhost:8888/applicationdetails/create";
const APPLICATIONDETAILS_API_BASE_URL_GET = "http://localhost:8888/applicationdetails/list";
