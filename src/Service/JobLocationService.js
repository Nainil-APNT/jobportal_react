...
const JOBLOCATION_API_BASE_URL = "http://localhost:8888/joblocation";
const JOBLOCATION_API_BASE_URL_CREATE = "http://localhost:8888/joblocation/create";
const JOBLOCATION_API_BASE_URL_GET = "http://localhost:8888/joblocation/list";
